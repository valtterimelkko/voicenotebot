...
The app captures audio from the browser microphone, streams chunks to the backend, transcribes the recording with OpenAI, cleans up the transcript with OpenAI, stores the result in SQLite, and makes it available in history and search.
